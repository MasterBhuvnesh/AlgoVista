...
const SideNav = () => {
  ...
  const navItems = [
    { path: "/linkedlist/aim", label: "Aim" },
    { path: "/linkedlist/overview", label: "Overview" },
    { path: "/linkedlist/quiz/1", label: "Pre Test", id: 1 },
    { path: "/linkedlist/basic", label: "Basic" },
    { path: "/linkedlist/quiz/2", label: "Post Test", id: 2 },
    {
