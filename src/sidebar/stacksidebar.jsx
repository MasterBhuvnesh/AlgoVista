...
const SideNav = () => {
  ...
  const navItems = [
    { path: "/stack/aim", label: "Aim" },
    { path: "/stack/overview", label: "Overview" },
    { path: "/stack/quiz/1", label: "Pre Test", id: 1 },
    { path: "/stack/basic", label: "Basic" },
    { path: "/stack/quiz/2", label: "Post Test", id: 2 },
    {
