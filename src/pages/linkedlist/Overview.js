      ...
      <div className="space-y-6">
        <section>
          ...
          <ul className="space-y-3 text-base text-gray-700">
            {[
              "Memory Allocation: Linked lists dynamically allocate memory for each node, so a basic understanding of how memory is allocated and managed is useful.",
              "Data Structures: Linked lists are a specific type of data structure, so familiarity with other data structures like arrays and their properties can be beneficial.",
              "Traversal and Manipulation: Knowing how to traverse a list and perform basic operations like insertion, deletion, and search can help in understanding linked lists.",
            ].map((item, index) => (
              <li
                key={index}
